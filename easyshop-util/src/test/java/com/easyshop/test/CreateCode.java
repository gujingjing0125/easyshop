...
public class CreateCode {
	...
	public void testGenerator() {
		...
		config.setActiveRecord(false) // 是否支持AR模式
				.setAuthor("gujingjing") // 作者是谁???
				.setOutputDir("C:\\sijieduan\\sijieduan-workspace\\easyshop-parent\\easyshop-util\\src\\main\\java") // 生成的代码保存的位置
		...
		stConfig.setCapitalMode(true) // 全局大写命名
				...
				//.setInclude("specification");
				.setInclude(new String[]{"tb_content","tb_content_category"}); // 需要逆向生成的表 生成的表

		// 4. 包名策略配置
		PackageConfig pkConfig = new PackageConfig();
		pkConfig.setParent("com.easyshop").setMapper("mapper") // com.house.mapper
				.setService("service") // com.house.service
				.setController("controller") // com.house.controller
				.setEntity("pojo") // com.house.bean
